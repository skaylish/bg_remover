...
const CONTENT: Record<string, {
  ...
  ko: {
    ...
    sections: [
      ...
      { heading: '제5조 (처리 위탁)', body: { cols: ['수탁업체', '위탁 업무'], rows: [['Google LLC', 'OAuth 소셜 로그인 인증'], ['Lemon Squeezy LLC', '결제 처리 및 결제 정보 관리'], ['Vercel Inc.', '서비스 호스팅'], ['Supabase Inc.', '데이터베이스 운영']] } },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: '5. Sub-Processors', body: { cols: ['Vendor', 'Purpose'], rows: [['Google LLC', 'OAuth authentication'], ['Lemon Squeezy LLC', 'Payment processing'], ['Vercel Inc.', 'Service hosting'], ['Supabase Inc.', 'Database']] } },
  ...
  ja: {
    ...
    sections: [
      ...
      { heading: '第5条（委託先）', body: { cols: ['委託先', '委託業務'], rows: [['Google LLC', 'OAuth認証'], ['Lemon Squeezy LLC', '決済処理'], ['Vercel Inc.', 'サービスホスティング'], ['Supabase Inc.', 'データベース']] } },
  ...
  es: {
    ...
    sections: [
      ...
      { heading: '5. Sub-procesadores', body: { cols: ['Proveedor', 'Propósito'], rows: [['Google LLC', 'Autenticación OAuth'], ['Lemon Squeezy LLC', 'Procesamiento de pagos'], ['Vercel Inc.', 'Hosting'], ['Supabase Inc.', 'Base de datos']] } },
  ...
  id: {
    ...
    sections: [
      ...
      { heading: '5. Sub-prosesor', body: { cols: ['Vendor', 'Tujuan'], rows: [['Google LLC', 'Autentikasi OAuth'], ['Lemon Squeezy LLC', 'Pemrosesan pembayaran'], ['Vercel Inc.', 'Hosting layanan'], ['Supabase Inc.', 'Database']] } },
